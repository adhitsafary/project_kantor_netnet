            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/perbaikan/">Perbaikan</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ asset('template/img/man.png') }}"
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="{{ asset('/template2/img/boy.pn') }}g"
                                    style="max-width: 60px">
                                <span class="ml-2 d-none d-lg-inline text-white small">Adit Sapari</span>
                            </a>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Pelanggan Baru
                                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">Perbaikan
                                            </div>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="small text-gray-500">Paket 5 Mbps
                                            <div class="small float-right"><b>600 User</b></div>
                                        </div>
                                        <div class="progress" style="height: 12px;">
                                            <div class="progress-bar bg-warning" role="progressbar"
                                    ...
                                    <div class="mb-3">
                                        <div class="small text-gray-500">Paket 10 Mbps
                                            <div class="small float-right"><b>500 User</b></div>
                                        </div>
                                        <div class="progress" style="height: 12px;">
                                            <div class="progress-bar bg-success" role="progressbar"
                                    ...
                                    <div class="mb-3">
                                        <div class="small text-gray-500">Paket 15 Mbps
                                            <div class="small float-right"><b>455 User</b></div>
                                        </div>
                                        <div class="progress" style="height: 12px;">
                                    ...
                                    <div class="mb-3">
                                        <div class="small text-gray-500">Paket 25 Mbps
                                            <div class="small float-right"><b>400 User</b></div>
                                        </div>
                                        <div class="progress" style="height: 12px;">
                                    ...
                                    <div class="mb-3">
                                        <div class="small text-gray-500">Paket 35 Mbps
                                            <div class="small float-right"><b>200 User</b></div>
                                        </div>
                                        <div class="progress" style="height: 12px;">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width: 30%" aria-valuenow="30" aria-valuemin="0"
